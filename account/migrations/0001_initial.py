    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_pincode', models.CharField(max_length=6, validators=[django.core.validators.RegexValidator(message='enter valid 6 digits pincode', regex='^\\d{6}$')])),
                ('business_landmark', models.CharField(max_length=255)),
                ('product_category', models.CharField(choices=[('electronics', 'ELECTRONICS'), ('fashion', 'FASHION'), ('home_appliances', 'HOME_APPLIANCES'), ('books', 'BOOKS'), ('beauty', 'BEAUTY'), ('sports', 'SPORTS'), ('toys', 'TOYS'), ('mobile_and_tablets', 'MOBILE AND TABLETS'), ('home_and_kitchen', 'HOME AND KITCHEN'), ('other', 'OTHER')], max_length=50)),
